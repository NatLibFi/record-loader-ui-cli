...
(function() {
	...
	if (program_args.options.some(function(option) {
	    ...
	    modules = program_args.hasOwnProperty('modules')
		? require(getRequirePath(program_args.modules))
		: {};
	    ...
	    recordLoader(program_args.args[0], modules, program_args.processor, config).then(
		function(result) {
